...
local browser1          = "/usr/local/src/waterfox/waterfox-bin"
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "q", function () awful.util.spawn( browser1 ) end, -- X
    ...
    -- ctrl+alt +  ...
    awful.key({ modkey1, altkey   }, "w", function() awful.util.spawn( "/usr/local/src/waterfox/waterfox-bin" ) end,
        {description = "Launch Waterfox", group = "alt+ctrl"}),
    awful.key({ modkey1, altkey   }, "e", function() awful.util.spawn( "nvim" ) end,
        {description = "Launch Neovim", group = "alt+ctrl"}),
    ...
    awful.key({ modkey1, altkey   }, "l", function() awful.util.spawn( "slock" ) end,
        {description = "slock", group = "alt+ctrl"}),
    ...
    awful.key({ modkey1, altkey   }, "s", function() awful.util.spawn( "/usr/local/src/sublime_text/sublime_text" ) end,
        {description = "Sublime Text", group = "alt+ctrl"}),
    awful.key({ modkey1, altkey   }, "t", function() awful.util.spawn( "qbittorrent" ) end,
        {description = "qbittorrent", group = "alt+ctrl"}),
    awful.key({ modkey1, altkey   }, "u", function() awful.util.spawn( "uget-gtk" ) end,
        {description = "uget-gtk", group = "alt+ctrl"}),
    ...
    awful.key({ altkey }, "t", function () awful.util.spawn( "transmission-gtk" ) end,
        {description = "transmission", group = "altkey"}),
    awful.key({ altkey }, "n", function () awful.util.spawn( "nitrogen" ) end,
        {description = "nitrogen", group = "altkey"}),
    awful.key({ altkey }, "p", function () awful.util.spawn( "pcmanfm" ) end,
        {description = "pcmanfm", group = "altkey"}),
    awful.key({ altkey }, "f", function () awful.util.spawn( "thunar" ) end,
